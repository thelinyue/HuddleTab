...
Assert-True (($uiParityPlaywright -join " ") -eq "run test:e2e -- ui-parity.spec.ts --project=chromium-ui-parity-desktop --project=chromium-ui-parity-mobile --project=chromium-ui-parity-compact") "UiParityOnly 没有固定到当前远程版本的 Desktop/Mobile/320x568 项目。"
