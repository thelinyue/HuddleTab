...
export default defineConfig({
  testDir: './e2e', testMatch: ['accounting-experience.spec.ts', 'activity-workspace.spec.ts', 'settlement-dates.spec.ts', 'settlement-cards.spec.ts'], outputDir: './artifacts/accounting-browser',
