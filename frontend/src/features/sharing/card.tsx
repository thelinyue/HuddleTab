  ...
  return (
    <article id={id} className="share-summary-card" data-state={summary.state} aria-label={`${summary.activityName}结算摘要`}>
      ...
      <div className="share-summary-card__content">
        ...
        {summary.state === "zero" ? <div className="share-summary-card__state"><ReceiptText aria-hidden="true" size={22} /><div><strong>结算金额为零</strong><p>当前总消费为零，无需转账。</p></div></div> : null}
