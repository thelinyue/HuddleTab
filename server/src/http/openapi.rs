...
use super::{
    ...
    auth::{
        ...
        __path_session, __path_update_avatar, AvatarPresetData, AvatarPresetEnvelope,
        ChangePasswordData, ChangePasswordEnvelope, ChangePasswordRequest, CsrfData, CsrfEnvelope,
        LoginData, LoginEnvelope, LoginRequest, LogoutData, LogoutEnvelope, RegisterData,
