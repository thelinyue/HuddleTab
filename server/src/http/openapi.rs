...
use super::{
    ...
    auth::{
        ...
        __path_logout, __path_register, __path_session, __path_update_avatar,
        __path_update_profile, __path_upload_avatar_image, AvatarBinary, AvatarPresetData,
        AvatarPresetEnvelope, ChangePasswordData, ChangePasswordEnvelope, ChangePasswordRequest,
        CsrfData, CsrfEnvelope, DisplayNameData, DisplayNameEnvelope, LoginData, LoginEnvelope,
        LoginRequest, LogoutData, LogoutEnvelope, RegisterData, RegisterEnvelope, RegisterRequest,
        SessionData, SessionEnvelope, UpdateAvatarPresetRequest, UpdateDisplayNameRequest,
